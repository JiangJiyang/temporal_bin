...
[
  {
    ...
    "source_map": {
      ...
      "密级": "封面",
      "项目状态": "固定为：初步设计",
      "项目建设地址（省）": "工程概况和主要经济指标",
      "项目建设地址（市）": "工程概况和主要经济指标",
      "项目建设具体地址": "工程概况和主要经济指标",
      "建设地点": "主要设计依据",
      "主要建设内容": "主要设计依据",
      "项目建设目标": "主要设计依据",
      "新增土地面积（平方米）": "建设规模及生产纲领",
      "新增建筑面积（平方米）": "建设规模及生产纲领",
      "土地购置费（元）": "概算表 - 土地征用费（征地费）",
      "改造建筑面积（平方米）": "主要设计及技术经济指标",
      "新增工艺设备台套数": "主要设计及技术经济指标",
      "改造设备台套数": "主要设计及技术经济指标",
      "招标设备台套数": "从表中提取",
      "进口设备台套数": "从表中提取",
      "工艺设备购置费（万元）": "工程概况和主要经济指标",
      "建筑工程费（万元）": "工程概况和主要经济指标",
      "安装工程费（万元）": "工程概况和主要经济指标",
      "其他费用（万元）": "工程概况和主要经济指标",
      "项目总投资（万元）": "工程概况和主要经济指标",
      "时间": "全文查找"
    }
  },
  {
